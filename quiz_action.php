...
if($_REQUEST['action'] == 'count'){
	...
	if($_REQUEST['action'] == 'edit') { //Update goes here
		...
		wp_redirect($wpframe_home . '/wp-admin/edit.php?page=JibuPro/quiz.php&message=updated');
	} else {
		...
		wp_redirect($wpframe_home . '/wp-admin/edit.php?page=JibuPro/question.php&message=new_quiz&quiz='.$quiz_id);
	}
